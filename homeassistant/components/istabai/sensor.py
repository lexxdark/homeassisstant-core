...
from .istabai_client import IstabaiClient, RoomsResponse, Room
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback):
    ...
    selected_homes = entry.data[CONF_SELECTED_HOME_LIST]
...
class IstabaiRoomFetchCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self):
        ...
        _LOGGER.log(logging.INFO, "Fetching data for home %i", self._home_id)
